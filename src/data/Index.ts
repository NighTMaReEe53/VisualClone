...
export const TreeFile: ITreeFile = {
  id: uuidv4(),
  name: "Vs Code Clone",
  isFolder: true,
  content: "",
          ...
          children: [
            {
              ...
              name: "index.ts",
              isFolder: false,
              content: `export interface ITreeFile {
  id: string;
  name: string;
  isFolder: boolean;
...
export const { addFileToTab, getAllDetails } = TreeFileSlice.actions;
